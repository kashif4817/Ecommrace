  ...
  return (
    <nav className="bg-gray-900 shadow-md px-6 py-3 flex items-center justify-between h-16">
      ...
      <ul className="flex items-center space-x-4 text-sm">
        <li><NavLink to="/home" className={navLinkStyle}>Home</NavLink></li>
        <li><NavLink to="/home/products" className={navLinkStyle}>Products</NavLink></li>
        <li className="hidden lg:block"><DropDown /></li>
        <li><NavLink to="/home/contact" className={navLinkStyle}>Contact</NavLink></li>
        <li><NavLink to="/home/about-us" className={navLinkStyle}>About</NavLink></li>
